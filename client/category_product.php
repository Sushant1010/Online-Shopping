...
<div class="clearfix"></div>
		...
		<?php
			...
			$query = "SELECT * FROM prod WHERE pname = '$pname' LIMIT 0,1";
			...
			$sql = "SELECT * FROM prod WHERE pname = '$pname' LIMIT " . $this_page_first_result . ', ' . $results_per_page;
...
<div>
	...
	<div class="row" style="width: 100%;">
		...
		<div class="col-md-8">
		<div class="bg-primary prodhead">Category : <?php echo $pname; ?> </div>
			<?php
			...
			{
				echo '<a class="btn btn-primary" style="margin-left:5px;" href="category_product.php?page='.$page.'">'.$page.'</a>';
